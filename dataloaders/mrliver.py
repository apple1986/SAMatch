...
class MRliverDataset(Dataset):
    def __init__(self, name, root, mode, size=None, id_path=None, nsample=None):
        ...
        if mode == 'train_l' or mode == 'train_u':
            with open(os.path.join(self.root, id_path), 'r') as f:
    ...
    def __getitem__(self, item):
        ...
        if "train" in self.mode:
            sample = h5py.File(self.root + "/slices/{}.h5".format(id), "r")
        else:
            sample = h5py.File(self.root + "/volumes/{}.h5".format(id), "r")
