...
from dataloaders.dataset_acdc import (
    BaseDataSets,
    RandomGenerator,
...
parser.add_argument("--data_path", type=str, default="./data/ACDC", help="Name of Experiment")
parser.add_argument("--save_path", type=str, default="./checkpoint", help="Name of Experiment")
parser.add_argument("--exp", type=str, default="ACDC/MedSam_ft", help="experiment_name: finetune medsam")
...
parser.add_argument("--labeled_num", type=str, default=LABELed_NUM, 
...
def train(args, snapshot_match_path, snapshot_sam_path):
    ...
    for epoch_num in iterator:
        ...
        for step, sampled_batch in enumerate(trainloader):
            ...
            # There are 3 boxes for 3 class objects. Here we random select one box
            idx = random.choice([0,1,2])
            img_w_bbox = img_w_bbox[:, idx, :].unsqueeze(1) # Bx1x4, cls=1,2,3
            img_w_gt = (img_w_gt == (idx+1)).long()
