...
parser.add_argument("--exp", type=str, default="MRliver/Unimatch_medsam_F2_iter30000_bbox10", help="experiment_name")
    ...
    for epoch_num in iterator:
        ...
        for i, ((img_x, mask_x),
            ...
            if iter_num < args.iter_num: # only update unimatch           
                ...
                img_x_3ch = torch.cat((img_x, img_x, img_x), dim=1)
                ...
                img_pd_bbox = get_bbox256_cv(mask_u_w, bbox_shift=10)
