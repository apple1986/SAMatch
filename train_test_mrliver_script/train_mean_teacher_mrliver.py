...
parser.add_argument('--exp', type=str,
                    default='MRliver/Mean_Teacher', help='experiment_name')
parser.add_argument('--model', type=str,
                    default='unet', help='model_name')
# labeled case and unlabeled baatch size
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            volume_batch, label_batch = volume_batch.to(cuda_num), label_batch.to(cuda_num)
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                for i_batch, sampled_batch in enumerate(valloader):
                    metric_i = test_single_volume(
                        ...
                        model, classes=num_classes, cuda_num=args.cuda_num)
