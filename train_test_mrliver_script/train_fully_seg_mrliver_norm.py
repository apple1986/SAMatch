...
from dataloaders.dataset_norm import BaseDataSets, RandomGenerator
from networks.net_factory import net_factory
from utils import losses, metrics, ramps
from val_2D_MRliver import test_single_volume, test_single_volume_ds

MODEL_BACKBONE = "nnUNet"
parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str,
                    default='./data/MRliver', help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='MRliver/'+'Fully_Supervised_'+MODEL_BACKBONE+'_norm', help='experiment_name')
parser.add_argument('--labeled_num', type=int, default=30,
                    help='labeled cases')
parser.add_argument('--model', type=str,
                    default=MODEL_BACKBONE, help='model_name, like: unet, efficient_unet')
...
def patients_to_slices(dataset, patiens_num):
    ...
    if "ACDC" in dataset:
        ...
        ref_dict = {"1": 64, "3": 192, "5": 320, "7": 448, "30": 1920}
    else:
        print("Error")
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            outputs = model(volume_batch) # notice, volume_batch did not normalize, shape: bsx1x256x256
