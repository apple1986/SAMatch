...
parser.add_argument('--exp', type=str,
                    default='checkpoint/ACDC/UNet_Fully_Supervised', help='experiment_name')
...
def Inference(FLAGS):
    ...
    snapshot_path = "/home/gxu/proj1/smatch/{}_{}/{}".format( #_labeled
        FLAGS.exp, FLAGS.labeled_num, FLAGS.model)
    test_save_path = "/home/gxu/proj1/smatch/{}_{}/{}_predictions/".format( #_labeled
        FLAGS.exp, FLAGS.labeled_num, FLAGS.model)
