...
parser.add_argument("--exp", type=str, default="MRliver/FixMatch_samus_F2_iter3000_debug", help="experiment_name")
...
parser.add_argument('--ckpt_samus', type=str, 
                    default='/home/gxu/proj1/smatch/checkpoint/MRliver/SAMUS_Point_case7/SAMUS_09242154_354_0.8482869294143915.pth', 
                    help='Fine-tuned SAM')
