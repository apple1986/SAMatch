...
parser.add_argument("--exp", type=str, default="MRliver/Unimatch", help="experiment_name")
...
parser.add_argument('--labeled_id_path', type=str,default="5/labeled.txt", required=False)
parser.add_argument('--unlabeled_id_path', type=str, default="5/unlabeled.txt", required=False)
...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        if is_best:
                ...
                if mean_dice > 0.1: 
                    torch.save(checkpoint, os.path.join(snapshot_path, str(round(mean_dice,2))+'.pth'))
