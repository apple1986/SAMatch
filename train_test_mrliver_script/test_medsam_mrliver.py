...
parser.add_argument(
    ...
    '--root_dir',
    type=str,
    default='/home/gxu/proj1/smatch/checkpoint/MRliver',
    # required=True,
...
parser.add_argument(
    '--checkpoint_path',
    type=str,
    default="Unimatch_medsam_F2_iter3000_bbox30_lr_1e_2_5_labeled_bs4/unet_drop",
...
parser.add_argument(
    ...
    '--input_dir_list',
    type=str,
    default='./data/MRliver/test.list',
    # required=True,
...
for case in tqdm(image_list):
    ...
    H, W = img_vol_256.shape[:2]
    pd_vol = np.zeros_like(label_vol)
    ## for each slice
    for idx in range(0, img_vol_256.shape[2]):
        img_256 = img_vol_256[:,:,idx]
        # img_256 = (img_256 - img_256.min()) / (img_256.max()- img_256.min()+1e-9) # normalize
