...
#parser.add_argument('--adapt_ckpt', type=str, default='/home/data/lxs/SAM_fitune/SAMUS/checkpoints/ACDC_3/SAMUS_06131702_300_0.6048044475955532.pth', help='The checkpoint after adaptation')
parser.add_argument('--adapt_ckpt', type=str, default='/home/data/lxs/SSL1/SAMatch/SAMUS_3labeled.pth', help='The checkpoint after adaptation')
parser.add_argument('--ckpt', type=str, default='/home/data/lxs/SAM_fitune/MA-SAM/sam_vit_b_01ec64.pth', help='Pretrained checkpoint')
...
parser.add_argument("--exp", type=str, default="ACDC/FixMatch_std_F3_case1", help="experiment_name")
...
#########################################
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            #loss_sam = sam_loss(predict[args.labeled_bs:],pseudo_outputs)*consistency_weight + sam_loss(predict[:args.labeled_bs],label_batch[:][: args.labeled_bs].long())
            ...
            loss = sup_loss + consistency_weight * (unsup_loss+unsup_loss_1)
            optimizer.zero_grad()
            loss.backward()
            optimizer.step()
...
if __name__ == "__main__":
    ...
    snapshot_path = "/home/data/lxs/SSL1/SAMatch/SAM_model/{}_{}/{}".format(args.exp, args.labeled_num, args.model)
