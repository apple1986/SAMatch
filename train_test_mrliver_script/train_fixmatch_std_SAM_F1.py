...
parser.add_argument('--adapt_ckpt', type=str, default='/home/data/lxs/SSL1/SAMatch/SAMUS_1labeled.pth', help='The checkpoint after adaptation')
...
parser.add_argument("--exp", type=str, default="ACDC/FixMatch_std_SAMUS_case7", help="experiment_name")
