...
parser.add_argument("--root_path", type=str, default="./data/MRliver", help="path of dataset")
parser.add_argument("--exp", type=str, default="MRliver/FixMatch_standard_augs_temp", help="experiment_name")
parser.add_argument("--model", type=str, default="unet", help="model_name")
parser.add_argument("--max_iterations", type=int, default=30000, help="maximum epoch number to train")
parser.add_argument("--labeled_num", type=int, default=5, help="labeled number of cases")
