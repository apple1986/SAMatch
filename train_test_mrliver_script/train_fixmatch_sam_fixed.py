...
parser.add_argument("--exp", type=str, default="MRliver/FixMatch_sam_pseudo_label_th0.9", help="experiment_name")
...
parser.add_argument( "--conf_thresh", type=float,default=0.9, help="confidence threshold for using pseudo-labels")
