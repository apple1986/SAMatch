...
#  =========================================== parameters setting ==================================================
MODEL_PATH = "FixMatch_samus_F2_high_prob_iter3000_5_labeled_bs4"
...
parser.add_argument('--sam_path', type=str, default='/home/gxu/proj1/smatch/checkpoint/MRliver/'+MODEL_PATH+'/unet/best_sam_model.pth', help='the path of MatchNet')
