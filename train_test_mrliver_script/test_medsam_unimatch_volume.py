...
#  =========================================== parameters setting ==================================================
MODEL_PATH = "Unimatch_medsam_F2_iter3000_bbox30_lr_1e_2_5_labeled_bs4"
...
parser.add_argument('--sam_path', type=str, default='/home/gxu/proj1/smatch/checkpoint/MRliver/'+MODEL_PATH+'/unet_drop/medsam_lite_best.pth', help='the path of MatchNet')
...
def load_matchnet(net_path):
    ...
    matchnet.load_state_dict(torch.load(net_path, map_location='cpu', weights_only=False)["model"])
