...
LABELED_NUM_USED = "0_5"
parser = argparse.ArgumentParser()
parser.add_argument("--root_path", type=str, default="./data/ACDC", help="Name of Experiment")
parser.add_argument("--save_path", type=str, default="./check", help="Name of Experiment")
parser.add_argument("--exp", type=str, default="ACDC/Unimatch_medsam_both_debug", help="experiment_name")
...
def train(args, snapshot_path):
    ...
    # medsam_logit_all = torch.zeros((batch_size, num_classes-1, 256, 256)).to(args.cuda_num)
    # medsam_logit_all.requires_grad = True
    for epoch_num in iterator:
        ...
        for i, ((img_x, mask_x),
            ...
            #     medsam_logit_all[:, n-1, :, :] = medsam_logit[:,0,:,:]
            # map_cls0 = (1 - torch.mean(medsam_logit_all, dim=1, keepdim=True))#.squeeze(1)
