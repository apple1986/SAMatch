...
class MaskDecoder(nn.Module):
    def __init__(
        ...
        *,
        ...
        num_multimask_outputs: int = 3, #3, ap
    ...
    def forward(
        ...
        masks, iou_pred = self.predict_masks(
            ...
            image_pe=image_pe,
            sparse_prompt_embeddings=sparse_prompt_embeddings, # points or boxes
            dense_prompt_embeddings=dense_prompt_embeddings, # masks
        )
