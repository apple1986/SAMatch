...
import utils.metrics_samus as metrics
...
def eval_volume(valloader, model, criterion, opt, args):
    model.eval()
...
def get_eval(valloader, model, criterion, opt, args):
    ...
    elif opt.eval_mode == "volume":
        return eval_volume(valloader, model, criterion, opt, args)
    else:
