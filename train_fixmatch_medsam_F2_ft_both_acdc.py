...
parser.add_argument("--root_path", type=str, default="./data/ACDC", help="path of dataset")
parser.add_argument("--exp", type=str, default="ACDC/FixMatch_MedSAM_both", help="experiment_name")
parser.add_argument("--model", type=str, default="unet", help="model_name")
parser.add_argument("--max_iterations", type=int, default=30000, help="maximum epoch number to train")
parser.add_argument("--labeled_num", type=str, default=LABELED_NUM, help="labeled number of cases")
parser.add_argument("--bbox_shift", type=int, default=10, help="bbox shift")
...
parser.add_argument('--ckpt_sam', type=str, 
                    default='/data/maia/gpxu/proj1/samatch/checkpoint/ACDC/MedSam_ft_'+str(LABELED_NUM)+'_labeled_bs4/medsam/medsam_lite_best.pth', 
                    help='Fine-tuned SAM')
parser.add_argument('--ckpt_fix', type=str, 
                    default='/data/maia/gpxu/proj1/samatch/checkpoint/ACDC/FixMatch_standard_augs_'+str(LABELED_NUM)+'_labeled_bs4/unet/unet_best_model.pth', 
                    help='Fine-tuned SAM')
